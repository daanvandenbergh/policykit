...
your second version, [writing a revision](/writing-a-revision) walks the authoring steps - or install
[`/policykit`](/policykit), the Claude Code skill that runs those steps for you. For titles, archive
routes, and the MDX component map, see [rendering policies](/rendering-policies).
